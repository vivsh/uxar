...
pub fn resolve_placeholders(
    sql: &str,
    arguments: &mut super::commons::Arguments<'static>,
...
mod tests {
    ...
    fn collect_parts(sql: &str) -> Vec<PlaceholderPart<'_>> {
    ...
    fn resolve_postgres_placeholders() {
        ...
        values.insert(
            "id".to_string(),
            super::super::argvalue::ArgValue::new(42i32),
        );
        values.insert(
            "name".to_string(),
            super::super::argvalue::ArgValue::new("Alice".to_string()),
        );
    ...
    fn resolve_increments_arguments_len() {
        ...
        values.insert(
            "name".to_string(),
            super::super::argvalue::ArgValue::new("Bob".to_string()),
        );
        values.insert(
            "age".to_string(),
            super::super::argvalue::ArgValue::new(30i32),
        );
    ...
    fn resolve_continues_from_existing_arguments() {
        ...
        values.insert(
            "status".to_string(),
            super::super::argvalue::ArgValue::new("active".to_string()),
        );
        values.insert(
            "type".to_string(),
            super::super::argvalue::ArgValue::new(5i32),
        );
